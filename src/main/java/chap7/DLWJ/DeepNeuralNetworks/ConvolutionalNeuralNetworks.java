package chap7.DLWJ.DeepNeuralNetworks;

import java.util.*;

import chap7.DLWJ.MultiLayerNeuralNetworks.HiddenLayer;
import chap7.DLWJ.SingleLayerNeuralNetworks.LogisticRegression;
import static chap7.DLWJ.util.RandomGenerator.binomial;
